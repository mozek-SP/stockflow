                                                                            ...
                                                                            {Array.from({ length: item.quantity }).map((_, snIdx) => (
                                                                                <div key={snIdx} className="relative group">
                                                                                    <Input 
                                                                                        ...
                                                                                        className={`text-[10px] h-8 font-mono pl-6 transition-all ${item.selected_sns[snIdx] ? "bg-emerald-50 border-emerald-300 text-emerald-700" : "bg-white border-slate-200 focus:border-violet-400 focus:ring-violet-500/10"}`}
