                                            ...
                                            {Array.from({ length: difference }).map((_, snIdx) => (
                                                <div key={snIdx} className="relative group">
                                                    <Input 
                                                        ...
                                                        className="text-sm h-10 font-mono bg-white border-slate-200 focus:border-emerald-400 focus:ring-emerald-500/10 transition-all pl-8 shadow-sm"
                                                    ...
                                                    />
                                                    <span className="absolute left-2.5 top-1/2 -translate-y-1/2 text-[10px] text-slate-300 font-bold group-focus-within:text-emerald-400">{snIdx + 1}</span>
                                                </div>
                                            ))}
                                        </div>
